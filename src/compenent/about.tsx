        ...
        <div id="1" className="flex md:flex-row flex-col md:items-start items-center bg-slate-950 h-max w-full p-4 ">
            ...
            <div className=" flex flex-col gap-3 md:w-2/3 w-full h-full md:items-start md:text-start items-center text-center">
                ...
                <div className="flex md:flex-row flex-col">
                    <Link target="blank" href={"https://drive.google.com/file/d/1hWgmOmYplb47e9oLhV3yKMORP67drago/view?usp=drive_link"}><button className="bg-blue-800 w-48 h-12 rounded-3xl mx-24 my-6 font-bold text-xl hover:bg-gray-800">Download CV</button></Link>
